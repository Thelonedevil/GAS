 ...
 */
public class compacterContainer extends Container {
    private CompacterTE tile;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public compacterContainer(InventoryPlayer player, CompacterTE tile) {
        this.tile = tile;
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (CompacterRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
