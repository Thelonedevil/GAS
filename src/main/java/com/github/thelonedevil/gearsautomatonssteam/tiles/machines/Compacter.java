 ...
 */
public class Compacter extends BaseMachine  {

    private final Random field_149933_a = new Random();
    private final boolean active;
    private static boolean crushing;
    @SideOnly(Side.CLIENT)
    private IIcon top;
    @SideOnly(Side.CLIENT)
    private IIcon front;

    public Compacter(boolean active) {
        this.active = active;
    }

    @Override
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new CompacterTE();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        if (world.isRemote) {
            ...
            player.openGui(GASMain.instance, Ref.COMPACTER_GUI_ID, world, x, y, z);
            return true;
        }
    }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Ref.MODID+":crusher_side");
        this.front = p_149651_1_.registerIcon(this.active ? Ref.MODID+":crusher_front_on" : Ref.MODID+":crusher_front_off");
        this.top = p_149651_1_.registerIcon(Ref.MODID+":crusher_top");
    }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((CompacterTE)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).setInvName(p_149689_6_.getDisplayName());
        }
    }
    @SideOnly(Side.CLIENT)
    ...
    public static void updateBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MyMachines.compacterActive);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MyMachines.compacter);
        }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!crushing)
        {
            CompacterTE tileentityfurnace = (CompacterTE)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
