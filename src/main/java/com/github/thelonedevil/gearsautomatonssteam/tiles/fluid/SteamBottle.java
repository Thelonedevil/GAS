 ...
 */
public class SteamBottle extends ItemBucket {

    private Block block;

    public SteamBottle(Block p_i45331_1_) {
        super(p_i45331_1_);
        block = p_i45331_1_;
        ...
        else
        {
            ...
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (flag)
                {
                    ...
                    if (material == MyFluids.steamMaterial && l == 0)
                    {
                        p_77659_2_.setBlockToAir(i, j, k);
                        return this.func_150910_a(p_77659_1_, p_77659_3_, MyFluids.steamBottle);
                    }
                ...
                else
                {
                    ...
                    {
                        return new ItemStack(MyFluids.steamBottleEmpty);
                    }
    ...
    public boolean tryPlaceContainedLiquid(World p_77875_1_, int p_77875_2_, int p_77875_3_, int p_77875_4_)
    {
        ...
        else
        {
            ...
            else
            {
                    ...
                    p_77875_1_.setBlock(p_77875_2_, p_77875_3_, p_77875_4_, this.block, 0, 3);
